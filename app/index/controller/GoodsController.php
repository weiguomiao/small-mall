...
class GoodsController extends BaseIndexController
{
    //分类下的商品列表
    public function index($id){
        //查询分类下的商品
        $list=Goods::where('cate_id',$id)->order('id','desc')->paginate(10);
        //查询分类信息
    ...
    public function detail($id)
    {
        //$id 是商品id
        //查询商品信息、商品相册、规格商品SKU
        $goods = Goods::with(['goods_images','spec_goods'])->find($id)->toArray();
